...
document.getElementById("nis").onkeydown = function (evt) {
    if (evt.key == "Enter" || evt.key == "Tab") {
        ...
        axios.get(`http://127.0.0.1:8000/pengembalian/tambah/${nis}`)
            .then(respon => {
                let p = respon.data
...
document.getElementById("kode_buku").onkeydown = function (e) {
    if (e.key == "Enter" || e.key == "Tab") {
        ...
        axios.get(`http://127.0.0.1:8000/pengembalian/tambah/Buku/${kode_buku}`)
            .then(respon => {
                let p = respon.data
...
// document.getElementById("jumlah").onkeydown = function (e) {
//     if (e.key == "Tab") {
//         e.preventDefault();
//         tambahProduk();
//     }
