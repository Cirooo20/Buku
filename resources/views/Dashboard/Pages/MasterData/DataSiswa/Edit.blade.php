...
@section('konten')
    <div class="container mx-auto px-4 py-8">
        <div class="mb-8">
            <h1 class="text-3xl font-bold mb-2 text-white">Edit Data Siswa</h1>
            <p class="text-gray-200">MasterData > Data Siswa > Edit</p>
        </div>
        ...
        <div class="bg-gray-800 rounded-lg shadow-lg p-6">
            <form method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="nis" name="nis" placeholder="Masukkan NIS" value="{{ $Siswa->nis }}"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="nama" name="nama" placeholder="Masukkan Nama" value="{{ $Siswa->nama }}"
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-900 leading-tight focus:outline-none focus:shadow-outline">
                    @error('nama')
                        <div class="alert alert-danger text-red-500" role="alert">
                            {{ $message }}
                ...
                <div class="mb-4">
                    ...
                    <textarea id="alamat" name="alamat" rows="3" placeholder="Masukkan Alamat"
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-900 leading-tight focus:outline-none focus:shadow-outline">{{ $Siswa->alamat }}</textarea>
                    @error('alamat')
                        <div class="alert alert-danger text-red-500" role="alert">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="no_telp" name="no_telp" placeholder="Masukkan No. Telp" value="{{ $Siswa->no_telp }}"
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-900 leading-tight focus:outline-none focus:shadow-outline">
                    @error('no_telp')
                        <div class="alert alert-danger text-red-500" role="alert">
                            {{ $message }}
                        ...
                        <select class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-900 leading-tight focus:outline-none focus:shadow-outline" name="kode_kelas" id="kode_kelas">
                            ...
                            @foreach ($Classroom as $class)
                                <option value="{{ $class->kode_kelas }}" 
                                    {{ $Siswa->kode_kelas == $class->kode_kelas ? 'selected' : '' }}>
                                    {{ $class->kode_kelas }}
                                </option>
                            @endforeach
                        </select>
