        ...
        <div class="overflow-x-auto mt-6">
            <table class="min-w-full bg-gray-700 text-white">
                ...
                <tbody class="bg-gray-600 divide-y divide-gray-500">
                    ...
                    <tr>
                        <td class="px-6 py-4 whitespace-nowrap"><img src="{{ asset('images/' . $DB->foto) }}" alt="Foto Buku" class="w-24 h-32 rounded-sm"></td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <a href="/databuku/edit/{{ $DB->kode_buku }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-2">
                                Edit
                            </a>
                            <a href="/databuku/hapus/{{ $DB->kode_buku }}" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">
                                Hapus
                            </a>
                        </td>
                    </tr>
