    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="bg-gray-800 rounded-lg shadow-lg p-6">
            ...
            <form action="" method="post" id="form" name="form">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama" id="nama"
                            class="form-input w-full text-black focus:outline-none" readonly value="{{ old('nama') }}">
                    </div>
                    <div class="mb-3">
                ...
                <table id="bookTable" class="min-w-full bg-gray-700 text-white border border-white border-collapse">
                    <thead>
