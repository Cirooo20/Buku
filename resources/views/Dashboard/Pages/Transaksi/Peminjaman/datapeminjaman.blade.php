...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-gray-800 rounded-lg shadow-lg p-6">
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="/peminjaman/tambah" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Tambah Peminjaman</a>
        </div>
        <div class="overflow-x-auto mt-6">
            <table class="min-w-full bg-gray-700 text-white">
                <thead>
                    <tr>
                        <th class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider">Kode Peminjaman</th>
                ...
                <tbody class="bg-gray-600 divide-y divide-gray-500">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            <a href="/peminjaman/detail/{{ $p->id }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Detail</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
