    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="bg-gray-800 rounded-lg shadow-lg p-6">
                ...
                <p class="text-sm text-gray-400 mt-2">Total anggota terdaftar</p>
            </div>

            <div class="bg-gray-800 rounded-lg shadow-lg p-6">
                <h2 class="text-xl font-semibold mb-4">Jumlah Buku</h2>
                <p class="text-3xl font-bold">{{ $JumlahBuku }}</p>
                <p class="text-sm text-gray-400 mt-2">Total koleksi buku</p>
            </div>
        ...
        <div class="mt-8 flex flex-wrap justify-between">
            @if (count($bukuTerpopuler) > 0)
                <div class="bg-gray-800 rounded-lg shadow-lg p-6 w-full md:w-[48%] mb-4 md:mb-0">
                    <h2 class="text-xl font-semibold mb-4">Buku Tervaforite</h2>
                    <div class="flex flex-col md:flex-row">
                        <img src="{{ asset('images/' . $bukuTerpopuler[0]['foto']) }}"
                            alt="{{ $bukuTerpopuler[0]['judul'] }}"
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-400 mt-1">{{ $bukuTerpopuler[0]['penulis'] }} |
                                {{ $bukuTerpopuler[0]['tahun_terbit'] }}</p>
            ...
            @else
                <div class="bg-gray-800 rounded-lg shadow-lg p-6 w-full md:w-[48%] mb-4 md:mb-0">
                    <h2 class="text-xl font-semibold mb-4">Buku Tervaforite</h2>
                    <p class="text-gray-400">Belum ada data buku yang dipinjam.</p>
                </div>
            @endif
            @if ($Awal)
        ...
        <div class="mt-8">
            <div class="bg-gray-800 rounded-lg shadow-lg p-6">
                ...
                <div class="mt-4 text-right">
                    <p class="text-lg font-bold">Total Jumlah Peminjaman: <span
                            class="text-xl text-blue-400">{{ $totalPeminjaman }}</span></p>
                </div>
            </div>
        </div>
    </div>
